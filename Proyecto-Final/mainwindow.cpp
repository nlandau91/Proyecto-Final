...
void MainWindow::on_btn_fullTest_clicked()
{
    ...
    {
        //parametros para realizar testeos con variedad de parametros
        ...
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,2.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,2.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,2.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,3.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,3.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,3.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,4.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,4.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,4.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,2.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,2.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,2.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,3.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,3.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,3.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,4.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,4.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,4.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,2.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,2.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,2.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,3.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,3.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,3.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,4.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,4.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,4.0,0.995,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,2.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,2.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,2.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,3.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,3.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,3.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,4.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,4.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,4.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,2.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,2.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,2.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,3.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,3.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,3.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,4.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,4.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,4.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,2.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,2.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,2.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,3.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,3.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,3.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,4.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,4.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,4.0,0.995,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,2.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,2.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,2.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,3.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,3.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,3.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,4.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,4.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,4.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,2.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,2.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,2.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,3.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,3.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,3.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,4.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,4.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,4.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,2.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,2.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,2.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,3.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,3.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,3.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,4.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,4.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,4.0,0.99,500,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,2.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,2.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,2.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,3.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,3.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,3.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::HOMOGRAPHY,4.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::HOMOGRAPHY,4.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::HOMOGRAPHY,4.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,2.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,2.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,2.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,3.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,3.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,3.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::AFFINE,4.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::AFFINE,4.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::AFFINE,4.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,2.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,2.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,2.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,3.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,3.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,3.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.5,fp::PARTIALAFFINE,4.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{2.0,fp::PARTIALAFFINE,4.0,0.99,250,app_settings.matcher_threshold});
        params_list.push_back(fp::Tester::TesterParameters{1.5,fp::PARTIALAFFINE,4.0,0.99,250,app_settings.matcher_threshold});
    }
